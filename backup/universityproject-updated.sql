...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2020 at 08:51 PM
...
CREATE TABLE IF NOT EXISTS `course` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=101204 ;
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  `password` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=20193411 ;
